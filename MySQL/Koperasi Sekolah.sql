/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     23/10/2022 11:45:03                          */
/*==============================================================*/
...
(
   ...
   NM_KASIR             varchar(15)  comment '',
   JENKEL_KASIR         varchar(15)  comment '',
   NOTELP_KASIR         varchar(30)  comment '',
   ALAMAT_KASIR         varchar(100)  comment '',
   EMAIL_KASIR          varchar(30)  comment '',
...
(
   ID_PEMBELI           char(6) not null  comment '',
   NM_PEMBELI           varchar(30)  comment '',
   NOTELP_PEMBELI       varchar(15)  comment '',
   ALAMAT_PEMBELI       varchar(100)  comment '',
...
(
   ...
   ID_PEM               char(10) not null  comment '',
   TGL_PENJUALAN        datetime  comment '',
...
(
   ...
   TGL_PENYEDIAAN       datetime  comment '',
...
(
   ID_SUPPLIER          char(6) not null  comment '',
   NM_SUPPLIER          varchar(30)  comment '',
